...
namespace SnipInsight.Controls.Ariadne
{
    ...
    public abstract class AriButtonBase : Button, IAriControl
    {
        ...
        public static readonly DependencyProperty IsShyProperty =
            DependencyProperty.Register("IsShy", typeof(bool), typeof(AriButtonBase), new PropertyMetadata(false, OnIsShyChangedStatic));
