...
namespace SnipInsight.Controls.Ariadne
{
    ...
    public class AriMenuItemBase : MenuItem, IAriControl
    {
        ...
        public static readonly DependencyProperty IsShyProperty =
            DependencyProperty.Register("IsShy", typeof(bool), typeof(AriMenuItemBase), new PropertyMetadata(false, OnIsShyChangedStatic));
        ...
        protected void RecomputeToolTip()
        {
            if (ToolTip == null)
            {
                ToolTip = Header;
